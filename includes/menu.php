...
function active_menu($page, $hshake){
  ...
  echo '<div class="ui mini horizontal statistic">';
    echo '<div class="label">Albums<div class="value">' . $hshake[albums] . '</div></div>';
  echo '</div>'
  echo '<div class="ui mini horizontal statistic">';
    echo '<div class="label">Artists<div class="value">' . $hshake[artists] . '</div></div>';
  echo '</div>'
  echo '<div class="ui mini horizontal statistic">';
    echo '<div class="label">Songs<div class="value">' . $hshake[songs] . '</div></div>';
  echo '</div>'
  echo '<div class="ui mini horizontal statistic">';
    echo '<div class="label">Genres<div class="value">' . $hshake[genres] . '</div></div>';
  echo '</div>'
  echo '<div class="ui mini horizontal statistic">';
    echo '<div class="label">Playlists<div class="value">' . $hshake[playlists] . '</div></div>';
  echo '</div>'
